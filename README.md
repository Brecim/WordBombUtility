...
## Downloads
Head to the [releases page](https://github.com/Brecim/WordBombUtility/releases) and download the .jar binary file. A modern Java JRE is required to make this application run.
...
I would also like to thank [artzified](https://github.com/artzified) for compiling [a nearly complete dictionary for this game](https://github.com/Artzified/WordBombDictionary) and [Word Bomb Library](https://wobtrain.com) for filling in the last gaps in the word list and both allowing this tool to be possible.
